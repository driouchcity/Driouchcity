...
def ai_gen(txt):
    try:
        ...
        # --- التعليمات المحدثة: محايد، بدون حشو، فقرات قصيرة/متوسطة ---
        pmt = f"""
        **الدور:** صحفي محترف ونزيه.
        ...
        3. الطول والأسلوب: يجب أن تكون الفقرات قصيرة إلى متوسطة الحجم (لا تتجاوز 3 أسطر لكل فقرة). يجب أن يكون الأسلوب **محايداً، صحفياً بحتاً، خالياً تماماً من أي مبالغة، حشو، أو تعابير رأي شخصية**. ركز على الحقائق والوقائع فقط.
        النص: {txt[:20000]}
        """
        # --- نهاية التحديث ---
